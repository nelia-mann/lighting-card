...
customElements.define("my-lighting-card", (0, _mainJs.MainCard));
...
},{"./main.js":"gLLPy"}],"gLLPy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MainCard", ()=>MainCard);
var _lit = require("lit");
var _mainStylesJs = require("./main.styles.js");
var _mainStylesJsDefault = parcelHelpers.interopDefault(_mainStylesJs);
class MainCard extends (0, _lit.LitElement) {
    // private properties:
    _hass;
    _buttonId;
    ...
    setConfig() {
        this._buttonId = input_boolean.test_button;
    }
    set hass(hass) {
        this._hass = hass;
    }
    // pull styles
    static styles = (0, _mainStylesJsDefault.default);
    // return html
    render() {
        return (0, _lit.html)`
            <ha-card>
                ...
                <div class="button-row">
                    <button
                        class="button clock ${this.isFloor("second")}"
                        id="second"
                        @click="${this.onClick}"
                    >
                        Second Floor
                    ...
                    <button
                        class="button timer ${this.isFloor("first")}"
                        id="first"
                        @click="${this.onClick}"
                    >
                        First Floor
                    ...
                    <button
                        class="button stopwatch ${this.isFloor("basement")}"
                        id="basement"
                        @click="${this.onClick}"
                    >
                        Basement
                    ...
                    <button
                        class="button stopwatch ${this.isFloor("outdoors")}"
                        id="outdoors"
                        @click="${this.onClick}"
                    >
                        Outdoors
...
},{"lit":"4antt","./main.styles.js":"i8Hw2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4antt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i8Hw2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lit = require("lit");
...
},{"lit":"4antt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3VwnP","8lqZg"], "8lqZg", "parcelRequire94c2", {})
