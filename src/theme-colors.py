def ThemeColor(hue, saturation, brightness, kelvin):
...
file_path = "/workspaces/HAcore/config/www/community/lighting-card/src/theme-colors.js"

with open(file_path, "w") as file:
    output = str(themeLibrary)
    output = "themeLibrary = " + output
